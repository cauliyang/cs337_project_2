...
if __name__ == "__main__":
    ...
    test_cases = [
        ...
        "Sauté the onions until golden brown, stirring occasionally.",
        "Chop the vegetables and mix them in a large bowl.",
        "Bake for 30 minutes, then remove from oven.",
        "Whisk together the eggs and cream, then fold into the mixture.",
        "Grill the chicken over medium heat, basting frequently.",
        "Boil the pasta, then drain and rinse with cold water.",
    ]
